...
public class ResultFile {
	...
	public static void checkFileExistance(String fileName, String dotFormat) {
		File x = new File("C:\\Users\\itszakaria_bd\\workspace\\appleWebAppDefault\\src\\test\\documentation\\" + fileName + dotFormat);
	...
	public static void writeTestResult(String filename, String dotFormat, String testName, String testResult) {
		Formatter f = null;
		try {
			f = new Formatter("C:\\Users\\itszakaria_bd\\workspace\\appleWebAppDefault\\src\\test\\documentation\\" + filename + dotFormat);
