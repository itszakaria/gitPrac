...
public class ResultFile {
	...
	public static void checkFileExistance(String fileName, String dotFormat) {
		File x = new File(System.getProperty("user.dir") + "\\src\\test\\documentation\\" + fileName + dotFormat);
	...
	public static void writeTestResult(String filename, String dotFormat, String testName, String testResult) {
		Formatter f = null;
		try {
			f = new Formatter(System.getProperty("user.dir") + "\\src\\test\\documentation\\" + filename + dotFormat);
