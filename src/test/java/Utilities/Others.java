...
public class Others {
	...
	public void writeTestResult(String filename, String dotFormat, String testName, String testResult) {
		...
		File x = new File(
				"C:\\Users\\itszakaria_bd\\workspace\\appleWebTest_BDD\\src\\test\\documentation\\" + filename + dotFormat);
	...
	public void writeResultToPropertiesFile(String testName, String testResult) throws IOException {
		...
		OutputStream fos = new FileOutputStream(
				"C:\\Users\\itszakaria_bd\\workspace\\appleWebTest_BDD\\src\\test\\documentation\\testResult.properties", true);
